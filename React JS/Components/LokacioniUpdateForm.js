...
function renderLokacioniTable(){
    return(
        ...
        <button onClick={() => setShowingCreateNewLokacioniForm(true)} className='btn btn-outline-dark btn-lg w-25 float-right m-1'>Create new Lokacion</button>
...
function onLokacioniDeleted(deletedLokacioniLokacioniID){
    let lokacioniCopy=[...lokacioni];
