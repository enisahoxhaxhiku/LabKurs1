...
export class AddPublicistetShqip extends Component{
                ...
                aria-labelledby="contained-modal-title-vcenter" centered>
                    <Modal.Header closeButton>
                        <Modal.Title id="contained-modal-title-vcenter">
                            Shto Publicistin e Librit Shqip
                        </Modal.Title>
                    </Modal.Header>
                    ...
                    <Modal.Body>
                        <Row>
                            ...
                            <Formik
                               ...
                               onSubmit={this.submitPublicistetP}
                             >
                                 {({ submitPublicistetP, isValid, isSubmitting, dirty }) => (
