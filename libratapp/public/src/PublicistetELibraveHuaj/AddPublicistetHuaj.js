...
export class AddPublicistetHuaj extends Component{

    constructor(props){
        super(props);
        this.submitPublicistetH=this.submitPublicistetH.bind(this);
                ...
                aria-labelledby="contained-modal-title-vcenter" centered>
                  <Modal.Header closeButton>
                        <Modal.Title id="contained-modal-title-vcenter">
                            Shto Publicicstin e Librit te Huaj
                        </Modal.Title>
                    </Modal.Header>
                    ...
                    <Modal.Body>
                        <Row>
                            ...
                            <Formik
                               ...
                               onSubmit={this.submitPublicistetH}
                             >
                                 {({ submitPublicistetH, isValid, isSubmitting, dirty }) => (
