...
export class AddAutoretShqip extends Component{
    constructor(props){
        super(props);
        this.submitAutoriSh=this.submitAutoriSh.bind(this);
    }
                    ...
                    <Modal.Body>
                        <Row>
                            ...
                            <Formik
                               ...
                               onSubmit={this.submitAutoriSh}
                             >
                                 {({ submitAutoriSh, isValid, isSubmitting, dirty }) => (
                                <Form onSubmit={this.submitAutoriSh}>
