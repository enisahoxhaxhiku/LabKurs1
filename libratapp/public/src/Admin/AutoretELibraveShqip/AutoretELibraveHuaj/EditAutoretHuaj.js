...
export class EditAutoretHuaj extends Component{
    constructor(props){
        super(props);
                        ...
                        <Row>
                            <Col sm={6}>
                                ...
                                <Form.Group controlId="AutoretHId ">
                                        <Form.Control type="text" name="AutoretHId " required hidden defaultValue={this.props.aktid} placeholder="AutoretHId " />
                                    </Form.Group>
