...
export class EditRevistatHuaj extends Component{

    constructor(props){
        super(props);
        this.submitRevistenH=this.submitRevistenH.bind();
    }
            ...
            <div className="container">
                ...
                aria-labelledby="contained-modal-title-vcenter" centered>
                    <Modal.Header closeButton>
                        <Modal.Title  id="contained-modal-title-vcenter">Update Revisten e Huaj</Modal.Title>
                    </Modal.Header>
                            ...
                            <Col sm={6}>
                                <Form onSubmit={this.submitRevistenH}>
                                    <Form.Group controlId="RevistatHID">
                                        <Form.Control  name="RevistatHID"required hidden defaultValue ={this.props.revid} 
                                        placeholder="RevistatHID"/>
                                    </Form.Group>
